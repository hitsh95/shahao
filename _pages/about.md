...
-	Sha, H., Li, H., Zhang, Y. & Hou, S. Deep learning-enhanced single-molecule spectrum imaging. APL Photonics 8(2023).
-	Jiang, Y., Sha, H., Liu, S., Qin, P. & Zhang, Y. AutoUnmix: an autoencoder-based spectral unmixing method for multi-color fluorescence microscopy imaging. Biomedical Optics Express 14(2023).
-	Sha hao., Liu Yangzhe. & Zhang Yongbing. 基于深度学习的傅里叶叠层成像技术. Laser & Optoelectronics Progress 58(2021).
